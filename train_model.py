...
val_data = pd.read_excel("validation_sample.xlsx")
...
print("Training Accuracy:", model.score(X_vectorized, y))
print("Validation Accuracy:", model.score(X_val_vectorized, y_val))
